...
public class Driver {
  ...
  public static void main(String[]args){
    ...
    if(Arrays.equals(start,result)){
      System.out.println("wait you didn't fail. "+name(type)+" array, size:"+size+" "+elapsedTime/1000.0+"sec ");
    }else{
      System.out.println("lul you failed. as usual.  "+name(type)+" array, size:"+size+"  ERROR!");
    }
  }
